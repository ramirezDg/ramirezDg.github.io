...
const TRANSLATIONS = {
  en: {
    ...
    about_p2: 'I am currently studying Systems and Computing Engineering at Universidad Tecnológica de Pereira (UTP), combining my academic training with building modern solutions — from corporate CRMs to robust SaaS platforms.',
    ...
    stat_edu: 'Systems and Computing Engineering — in progress',
    ...
    proj_stickyai_desc: 'Local-first sticky note app powered by a Small Language Model running on your GPU. Each note is auto-classified and placed across 7 simultaneous views: Kanban, Eisenhower Matrix, Story Map, Business Canvas and more. No cloud, no API costs.',
    ...
    edu_utp_degree: 'Systems and Computing Engineering',
  ...
  es: {
    ...
    about_p2: 'Actualmente curso Ingeniería de Sistemas y Computación en la Universidad Tecnológica de Pereira (UTP), combinando mi formación académica con la construcción de soluciones modernas, desde CRMs corporativos hasta plataformas SaaS de arquitectura robusta.',
    ...
    stat_edu: 'Ingeniería de Sistemas y Computación — en formación',
    ...
    proj_stickyai_desc: 'App de notas local-first con un Small Language Model que clasifica cada post-it automáticamente y lo ubica en 7 vistas simultáneas: Kanban, Eisenhower, Story Map, Canvas de Negocio y más. Sin nube, sin costos de API.',
    ...
    edu_utp_degree: 'Ingeniería de Sistemas y Computación',
